...
class Student:
    def __init__(self,root):
      ...
      title_lbl=Label(text="",font=("times new roman",35,"bold"),bg="black",fg="red")
      ...
      img=Image.open(r"C:\Users\khushi yadav\Desktop\Face_Recognition_System\Images\student1.png")
    ...
    # SecondImage
      ...
      # img1=Image.open(r"C:\Users\khushi yadav\Desktop\Face_Recognition_System\Images\frame.jpg")
...
# thirdImage
      # img2=Image.open(r"C:\Users\khushi yadav\Desktop\Face_Recognition_System\Images\frame.jpg")
...
# backgroundImage
      ...
      # title_lbl=Label(bg_img,text="STUDENT MANAGEMENT SYSTEM",font=("times new roman",35,"bold"),bg="black",fg="red")
      ...
      img_left=Image.open(r"C:\Users\khushi yadav\Desktop\Face_Recognition_System\Images\s1.jpg")
...
# current course
      ...
      dep_combo['values']=("Select Department","CSE","AGRICULTURE","Mechanical","Electronics","Dairy","Fisheries")
      dep_combo.current(0)
      ...
      course_combo['values']=("Select course","CE","btech","mtech","Ec","be","te")
...
# class student info
      ...
      # save btn
      save_btn=Button(btn_frame,text="Save",command=self.add_data,width=17,font=("times new roman",13,"bold"),bg="lightblue")
      save_btn.grid(row=0,column=0)

      # update
      update_btn=Button(btn_frame,text="Update",command=self.update_data,width=17,font=("times new roman",13,"bold"),bg="lightblue")
      update_btn.grid(row=0,column=1)
      

      # delete
      delete_btn=Button(btn_frame,text="Delete",command=self.delete_data,width=17,font=("times new roman",13,"bold"),bg="lightblue")
      delete_btn.grid(row=0,column=2)

      # reset
      reset_btn=Button(btn_frame,text="Reset",width=17,font=("times new roman",13,"bold"),bg="lightblue")
      ...
      btn_frame1.place(x=5,y=235,width=725,height=35)




      # take phtot sample
      take_photo_btn=Button(btn_frame1,command=self.generate_dataset,text="Take Photo",width=35,font=("times new roman",13,"bold"),bg="lightblue")
      take_photo_btn.grid(row=0,column=0)


      update_photo_btn=Button(btn_frame1,text="Update Photo",width=35,font=("times new roman",13,"bold"),bg="lightblue")
      ...
      img_right=Image.open(r"C:\Users\khushi yadav\Desktop\Face_Recognition_System\Images\s2.jpg")
 ...
 # table frame
      ...
      ("dep","course","year","sem","id","name","div","roll","gender","phone","dob","email","address","teacher","photo")
    ...
    def add_data(self):
         if self.var_dep.get()=="Select Department"or self.var_std_name.get()== "" or self.var_std_id.get()=="":
          messagebox.showerror("error","All Fields Are Required",parent=self.root)
            ...
            try:
             conn = mysql.connector.connect(host="localhost",username="root",password="Khushi@9876",database="face_recogniser")
                    ...
                    try:
                        ...
                        if delete>0:
                          ...
                          my_cursor.execute(sql,val)
                            ...
                            messagebox.showerror("Delete","Succesfully deleted  student details",parent=self.root)
                            conn.commit()
                            self.fetch_data()
                            conn.close()
                    except Exception as es:
         ...
         messagebox.showerror("Error","All fields are required",parent=self.root) 
            ...
            try:
               ...
               conn.close()
                  ...
                  #   load data
               face_classifier=cv2.CascadeClassifier(r"C:\Users\khushi yadav\AppData\Local\Programs\Python\Python312\Lib\site-packages\cv2\data\haarcascade_frontalface_default.xml") 
