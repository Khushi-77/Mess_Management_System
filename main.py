...
# help
      img7=Image.open(r"Images\menu.jpg")
      ...
      b1_1=Button(bg_img,text="Menu",cursor="hand2",command=self.help_data,font=("times new roman",15,"bold"),bg="black",fg="red")
      b1_1.place(x=1100,y=300,width=220,height=40)


# train

      img8=Image.open(r"Images\Train_Data.jpg")
